...
export default function BuyerSignupPage() {
    ...
    switch (field) {
      ...
      case 'buyer_type':
        ...
        if (!value) {
          ...
          newErrors.buyer_type =
            'Please select a buyer type'

        } else {

          delete newErrors.buyer_type
  ...
  const handleChange = (field, value) => {
    ...
    // Clear backend error when user changes input
    setBackendError('')


    // If mobile is being changed,
    // also remove the duplicate-number error.
    ...
    try {
      ...
      if (
        ...
        setTimeout(() => {
          ...
          window.open(`/buyer/${response.buyer_id}/dashboard`,'_blank')
      ...
      // -----------------------------------------------
        ...
        if (
          ...
          setBackendError(
            'This number already exists. Please use a different number.'
          )
  ...
  console.log('Buyer signup error:', message)
  ...
  if (
    lowerMessage.includes('mobile number already registered') ||
    lowerMessage.includes('mobile already registered') ||
    lowerMessage.includes('mobile number already exists') ||
    lowerMessage.includes('mobile already exists') ||
    lowerMessage.includes('number already registered')
  ) {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">
            Join DigiFarm and connect with verified
